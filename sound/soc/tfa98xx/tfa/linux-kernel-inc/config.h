...
enum tfa98xx_dsp_fw_state {
       ...
       TFA98XX_DSP_FW_FAIL,
       TFA98XX_DSP_FW_FAIL_COUNT,
       TFA98XX_DSP_FW_FAIL_REG_DSP,
       TFA98XX_DSP_FW_FAIL_PROBE,
       TFA98XX_DSP_FW_OK,
};
...
struct tfa98xx {
	...
	bool tapdet_active;
	tfa98xx_status status;
	struct miscdevice tapdet_device;
	struct mutex tapdet_mutex;
	struct delayed_work tapdet_enable_work;
