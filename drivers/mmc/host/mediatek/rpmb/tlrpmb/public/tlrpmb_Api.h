...
//Command ID's for Meizu Secure Storage 
#define CMD_MZSS_GET_RSA_SEED		7
#define CMD_MZSS_IS_DEV_ROOED		8
#define CMD_MZSS_IS_DEV_LOCKED		9
#define CMD_MZSS_ROOT_DEVICE		10
#define CMD_MZSS_UNROOT_DEVICE		11
#define CMD_MZSS_LOCK_DEVICE		12
#define CMD_MZSS_UNLOCK_DEVICE		13
