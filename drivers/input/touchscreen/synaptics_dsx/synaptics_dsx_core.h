...
#ifdef CONFIG_TOUCHSCREEN_SYNAPTICS_CUST_GESTURE
ssize_t synaptics_rmi4_gesture_value_read(struct device *dev,struct device_attribute *attr, char *buf);
ssize_t synaptics_rmi4_gesture_test(struct device *dev,struct device_attribute *attr, char *buf);
ssize_t synaptics_rmi4_gesture_control_read(struct device *dev,struct device_attribute *attr, char *buf);
ssize_t synaptics_rmi4_gesture_control_write(struct device *dev,struct device_attribute *attr, const char *buf, size_t count);
ssize_t synaptics_rmi4_gesture_hex_read(struct device *dev,struct device_attribute *attr, char *buf);
ssize_t synaptics_rmi4_gesture_hex_write(struct device *dev,struct device_attribute *attr, const char *buf, size_t count);
...
void synaptics_rmi4_sleep_enable(struct synaptics_rmi4_data *rmi4_data,bool enable);
#endif
