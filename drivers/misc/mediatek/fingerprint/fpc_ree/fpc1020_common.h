...
#define pr_debug(format, arg...)        printk(KERN_EMERG LOG_TAG_FPC format , ## arg)
...
#define dev_alert(dev, format, arg...)  dev_printk(KERN_EMERG, dev, format , ## arg)
