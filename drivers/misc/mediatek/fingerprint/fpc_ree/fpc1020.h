...
#define FPC_DEBUG 0
#if FPC_DEBUG
#define LOG_TAG_FPC "[fpc]"
#define pr_info(format, arg...)         printk(KERN_EMERG LOG_TAG_FPC format , ## arg)
#define pr_err(format, arg...)          printk(KERN_EMERG LOG_TAG_FPC format , ## arg)
#define dev_err(dev, format, arg...)    printk(KERN_EMERG LOG_TAG_FPC format , ## arg)
#define dev_info(dev, format, arg...)   printk(KERN_EMERG LOG_TAG_FPC format , ## arg)
#define dev_dbg(dev, format, arg...)    printk(KERN_EMERG LOG_TAG_FPC format , ## arg)
#define dev_warn(dev, format, arg...)   printk(KERN_EMERG LOG_TAG_FPC format , ## arg)
#define dev_notice(dev, format, arg...) printk(KERN_EMERG LOG_TAG_FPC format , ## arg)
#endif
