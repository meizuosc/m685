...
static unsigned int heavy_task_threshold2 = 500; /* max=1023 for AHT, threshold  */
static unsigned int avg_heavy_task_threshold = 39; /* max=99 for AHT, admission control */
