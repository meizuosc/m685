...
#include "common/imx386otp/imx386otp.h"
#include "common/ov5695otp/ov5695otp.h"
...
#endif
	{CMD_IMX386, imx386otp_selective_read_region},
	{CMD_OV5695, ov5695otp_selective_read_region},
...
#endif
	{IMX386_SENSOR_ID, 0xA0, CMD_IMX386, cam_cal_check_mtk_cid},
	{IMX386SUNNY_SENSOR_ID, 0xA0, CMD_IMX386, cam_cal_check_mtk_cid},
	{OV5695_SENSOR_ID, 0xC0, CMD_OV5695, cam_cal_check_mtk_cid},
	{OV5695TECH_SENSOR_ID, 0xC0, CMD_OV5695, cam_cal_check_mtk_cid},
	/*  ADD before this line */
