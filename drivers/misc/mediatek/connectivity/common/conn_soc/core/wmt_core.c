...
#endif
 VOID wmt_core_dump_func_state(PINT8 pSource);
...
MTK_WCN_BOOL wmt_core_get_any_func_state(void)
{
	return gMtkWmtCtx.eDrvStatus[WMTDRV_TYPE_BT]||gMtkWmtCtx.eDrvStatus[WMTDRV_TYPE_GPS]\
		    ||gMtkWmtCtx.eDrvStatus[WMTDRV_TYPE_WIFI]  ;
