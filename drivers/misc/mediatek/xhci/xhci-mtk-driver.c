...
u32 xhci_debug_level = K_ALET | K_CRIT | K_ERR | K_WARNIN|K_DEBUG;
...
#endif
#ifdef MEIZU_M80
#if defined(CONFIG_MTK_FAN54511_SUPPORT)
        fan54511_main_BOOSTEN(0X01);
        fan54511_set_OTG(0X01);
#endif
#if defined(CONFIG_MTK_BQ2589X_SUPPORT)
        bq2589x_boost_mode_enable(1);
#endif
#endif
}
...
#ifdef MEIZU_M80
#if defined(CONFIG_MTK_FAN54511_SUPPORT)
//        fan54511_main_BOOSTEN(0X0);
 //       fan54511_set_OTG(0X0);
#endif
#if defined(CONFIG_MTK_BQ2589X_SUPPORT)
            bq2589x_boost_mode_enable(0);
#endif
#endif
}
...
/*	mt_gpio_set_debounce(iddig_gpio, iddig_debounce);*/
	...
	retval =
		request_irq(mtk_idpin_irqnum, xhci_eint_iddig_isr, IRQF_TRIGGER_NONE, "iddig_eint",
			NULL);
	if (retval != 0) {
