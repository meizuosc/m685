...
#ifdef MEIZU_M80
#if defined(SOC_BY_3RD_FG)
    *(kal_int32*)(data) = bq27532_battery_current_now();
		return STATUS_OK;
#endif
#endif
...
#ifdef MEIZU_M80
#if defined(SOC_BY_3RD_FG)
	//*(kal_int32 *)(data) = bq27532_get_remaincap();
	return STATUS_OK;
...
static kal_int32 fgauge_get_soc(void *data)
{
    ...
    *(kal_int32*)(data) = bq27532_battery_read_soc();
...
#ifdef MEIZU_M80
#if defined(SOC_BY_3RD_FG)
		bm_func[BATTERY_METER_CMD_GET_FG_SOC] = fgauge_get_soc;
		bm_func[BATTERY_METER_CMD_SET_FG_TEMP] = fgauge_set_temp;
#endif
#endif
