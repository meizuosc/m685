...
#include <fan53555.h>
#endif
#if defined(EXTERNAL_BUCK_RT5735)
#include <rt5735.h>
#endif
...
int is_ext_buck2_exist(void)
{
	...
	if ((is_fan53555_exist() == 1))
		...
		return 0;
#elif defined(EXTERNAL_BUCK_RT5735)
		return 1;
#else
	return 0;
#if 0
...
static int pmic_hw_rst_notifier(struct notifier_block *this,
		unsigned long code, void *data)
{
	if (code) {//code = 1, disable the pmic hw reset function
		pmic_config_interface(MT6351_TOP_RST_MISC, 0x01, MT6351_PMIC_RG_PWRKEY_RST_EN_MASK,
				MT6351_PMIC_RG_PWRKEY_RST_EN_SHIFT);
		pmic_config_interface(MT6351_TOP_RST_MISC, 0x01, MT6351_PMIC_RG_HOMEKEY_RST_EN_MASK,
				MT6351_PMIC_RG_HOMEKEY_RST_EN_SHIFT);
	} else {
		/*enable the pmic hw reset function*/
		pmic_config_interface(MT6351_TOP_RST_MISC, 0x01, MT6351_PMIC_RG_PWRKEY_RST_EN_MASK,
				MT6351_PMIC_RG_PWRKEY_RST_EN_SHIFT);
		pmic_config_interface(MT6351_TOP_RST_MISC, 0x00, MT6351_PMIC_RG_HOMEKEY_RST_EN_MASK,
				MT6351_PMIC_RG_HOMEKEY_RST_EN_SHIFT);
	}
	return NOTIFY_OK;
}

static struct notifier_block pmic_rst_notifier = {
	.notifier_call = pmic_hw_rst_notifier,
};
...
/*#if defined(CONFIG_MTK_FPGA)*/
	...
	/*add by txy for M95*/
	ret = register_hw_reset_notifier(&pmic_rst_notifier);
