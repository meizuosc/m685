...
typedef struct {
	...
	*/
	...
	long (*set_gpio_lcd_vddi18)(unsigned int value);
	long (*set_gpio_lcd_power_sequence)(unsigned int value);
...
#ifdef MEIZU_M80
	void (*set_hbm)(unsigned int onoff);
	void (*set_lut)(unsigned int val);
	unsigned int (*get_panel_id) (void);
#endif
} LCM_DRIVER;
