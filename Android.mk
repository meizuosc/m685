...
.PHONY: kernel save-kernel kernel-savedefconfig %config-kernel clean-kernel ctags cscope
...
ctags:
	$(MAKE) -C $(KERNEL_OUT) $(KERNEL_MAKE_OPTION) tags

cscope:
	$(MAKE) -C $(KERNEL_OUT) $(KERNEL_MAKE_OPTION) cscope
