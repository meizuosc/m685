				     ...
				     int *errcode, int max_page_order)
{
	...
	/* 2016-2-2, Add start by MEIZU BSP@YinShunQing, fixed bug #282690 atomic sleep warning bug */
#ifndef MEIZU_M80
	...
	skb = alloc_skb_with_frags(header_len, data_len, max_page_order,
				   errcode, GFP_ATOMIC);
#endif
	/* 2016-2-2, Add end by MEIZU BSP@YinShunQing, fixed bug #282690 atomic sleep warning bug */
	if (skb)
		skb_set_owner_w(skb, sk);
	return skb;
